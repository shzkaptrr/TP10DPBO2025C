    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="index.php?entity=student&action=add" 
                    ...
                    <?php if (empty($studentList)): ?>
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                ...
                                No students found. 
                                <a href="index.php?entity=student&action=add" class="text-blue-600 hover:text-blue-800">
                        ...
                        <tr class="<?= $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' ?> hover:bg-blue-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-xs text-gray-500">
                                    (<?= htmlspecialchars($student['department_code']) ?>)
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex justify-center space-x-2">
                                    <a href="index.php?entity=student&action=edit&id=<?= $student['id'] ?>" 
                                    ...
                                    <a href="index.php?entity=student&action=delete&id=<?= $student['id'] ?>" 
        ...
        <div class="bg-gray-50 px-6 py-3 border-t border-gray-200">
            <div class="flex justify-between items-center text-sm text-gray-600">
                <div>
                    ...
                    Total: <?= count($studentList) ?> student(s)
                </div>
